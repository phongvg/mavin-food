$(document).ready(function(){
    ...
    var numberOfProducts = $("#panigation-doc .doc-item").length;
    var limitPerPage = 9;
    
    $("#panigation-doc .doc-item:gt(" + (limitPerPage -1 )+")").hide();
    ...
    $('.pagi li.current-page').on("click", function(){
        if($(this).hasClass("active")){
            ...
            $("#panigation-doc .doc-item").hide();
            var total = limitPerPage * currentPage;
            for(let i = total - limitPerPage; i<total; i++){
                $("#panigation-doc .doc-item:eq("+ i +")").show();
            }
        }
    });
